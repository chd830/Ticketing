...
public class SelectedTicketDAO {
	...
	public SelectedTicketDTO selectTicket(String userId) {
		...
		SelectedTicketDTO stdto = sessionTemplate.selectOne("ticketMapper.selectTicket",userId);
		return stdto;
	}
	...
	public UserInfoDTO selectUserInfo(String userId) {
		...
		UserInfoDTO uidto = sessionTemplate.selectOne("ticketMapper.selectUserInfo",userId);
		return uidto;
	...
	public AutoImageDTO selectAutoImage(int imageNum) {
		...
		AutoImageDTO aidto = sessionTemplate.selectOne("ticketMapper.selectAutoImage",imageNum);
		return aidto;
	...
	public List<SelectedTicketDTO> seatSelectTicket(String userId) {
		
		List<SelectedTicketDTO> list = sessionTemplate.selectList("ticketMapper.seatSelectTicket",userId);
