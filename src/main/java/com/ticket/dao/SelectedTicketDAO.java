...
public class SelectedTicketDAO {
	...
	public void inwon_updateData(String performCode,String userId, String inwon, int ticketprice){
	...
	public int p_SeatPrice(String performCode){
		
		int price = sessionTemplate.selectOne("ticketMapper.p_SeatPrice",performCode);
